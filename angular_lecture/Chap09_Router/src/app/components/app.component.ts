    ...
    template: `
        <div class="card-body">
            ...
            <div class="card-body">
                ...
                <a [routerLink]="['/productData', 250]">PRODUCT DATA</a> | 
                <a [routerLink]="['/productArgs']" [queryParams]="{isProd: true, name: 'yoda', age: 31}">PRODUCT ARGS</a> | 
                ...
                <button (click)="goURL('/productParam/50')">Product Param</button>
                <button (click)="goURLArg('/productArgs', {queryParams: {isProd: true, name: 'ji-song', age: 11}})">ARGS</button>
            </div>

            <div class="card-body">
                <!-- component가 로드 될 위치
                    router module이 먼저 로드되어 있어야 에러가 아님
                -->
...
export class AppComponent  { 
    ...
    // 경로 참조를 위한 route를 주입받아 그 메서드를 이용
