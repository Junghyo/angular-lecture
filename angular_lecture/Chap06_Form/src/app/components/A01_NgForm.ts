    ...
    template: `
        <div class="card-body">
            ...
            <div>
                ...
                <br/>
                lastName Value: {{lastName.value}}<br/>
                lastName Valid: {{lastName.valid}}
                <br/>
            </div>
            <!--ngModel을 <form> tag 안에서 사용하는 경우 name 속성이 필수 -->
                <form #myForm="ngForm" (submit)="onSendData(myForm)">
                    <div>
                        <label>UserName:</label>
                        <input type="text" class="form-control" name="firstName" [(ngModel)]="firstName">
                        <input type="text" class="form-control" name="lastName" ngModel required="true" #lastName="ngModel">
                    </div>
                    <br>
                    ...
                    <div>
                        ...
                        <input type="text" class="form-control" name="pwd" ngModel>
                    </div>
                    <br>

                    <div>
                        <label>Confirm password : </label>
                        <input type="password" class="form-control" name="repwd" ngModel>
                    </div>
                    <br>
