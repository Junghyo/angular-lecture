...
export class A04OneComponent {
    ...
    @Output() private sendNameEvent: EventEmitter<string> = new EventEmitter();
    @Output() private sendObjEvent: EventEmitter<EventObjType> = new EventEmitter();
