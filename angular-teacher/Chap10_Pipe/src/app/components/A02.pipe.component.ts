        ...
        <div class="card-body">
            ...
            <div class="card-body">
                ...
                <div>
                    ...
                    3. {{ 12.3456789 | percent : '1.1' }}<br>
                    4. {{ 12.3456789 | percent : '1.2' }}<br>
                    5. {{ 12.3456789 | percent : '1.1-3' }}<br>
                </div>
                <br>
                ...
                <div>
                    ...
                    3. {{ 12.3456789 | number : '1.1' }}<br>
                    4. {{ 12.3456789 | number : '1.1-1' }}<br>
                    5. {{ 12.3456789 | number : '1.2-2' }}<br>
                    5. {{ 12.3456789 | number : '1.2-4' }}<br>
                </div>
                <br>
